(function() {
  ...
  const dict = {
    ...
    /* Sınav Tarihleri sayfası */
    'Sınav Takvimi': 'Exam Schedule',
    'Sınav Tarihleri': 'Exam Dates',
    'LCM ve Vaganova sınav takvimlerimizi takip edin, öğrencilerimizin önemli dönüm noktalarına hazırlanın.': 'Follow our LCM and Vaganova exam schedules and prepare our students for important milestones.',
    'Sınavlar yükleniyor...': 'Loading exams...',
    'En Yakın Sınav': 'Nearest Exam',
    'Gün': 'Days',
    'Saat': 'Hours',
    'Dakika': 'Minutes',
    'Saniye': 'Seconds',
    'Sonraki Sınavlar': 'Upcoming Exams',
    'Şu anda yakında yapılacak sınav bulunmamaktadır.': 'There are no upcoming exams at the moment.',
    'Yakında başka sınav bulunmamaktadır.': 'No other upcoming exams.',
    'Sınavlar yüklenirken hata oluştu.': 'An error occurred while loading exams.',
    'Hızlı Erişim': 'Quick Access',
    'Sosyal Medya': 'Social Media',
    '© 2025 Destinalite Sanat Akademisi. Tüm hakları saklıdır.': '© 2025 Destinalite Art Academy. All rights reserved.'
  };
